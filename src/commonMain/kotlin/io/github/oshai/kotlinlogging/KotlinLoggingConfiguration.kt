...
public expect object KotlinLoggingConfiguration {
   ...
   * applies if [logFactory] is set to use [io.github.oshai.kotlinlogging.internal.DirectLoggerFactory]. On Native/JS/Wasm, this is the
   * default mechanism.
   */
  ...
  /**
   * Configuration for the **Direct Logging** implementation. On JVM/Android/Darwin, this ONLY
   * applies if [logFactory] is set to use [io.github.oshai.kotlinlogging.internal.DirectLoggerFactory].
   */
