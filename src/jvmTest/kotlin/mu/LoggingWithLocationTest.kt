...
class LoggingWithLocationTest {
	...
	fun testNullLoggingWithLocationEntryExit() {
		...
		Assert.assertEquals(
			"TRACE ClassWithLoggingForLocationTesting.logEntry(19) -  entry with (1, 2)" +
                    System.lineSeparator() + "INFO " + "ClassWithLoggingForLocationTesting.logEntry(20) - log entry body" +
                    System.lineSeparator() + "TRACE " + "ClassWithLoggingForLocationTesting.logEntry(21) - exit with ((2, 1))",
	...
	fun testNullLoggingWithLocationEntryExitOpt() {
		...
		Assert.assertEquals(
			"TRACE ClassWithLoggingForLocationTesting.logExitOpt(24) -  entry with (1, 2)" +
                    System.lineSeparator() + "INFO ClassWithLoggingForLocationTesting.logExitOpt(25) - log entry body" +
                    System.lineSeparator() + "TRACE ClassWithLoggingForLocationTesting.logExitOpt(26) - exit with (null)",
			appenderWithWriter.writer.toString().trim()
		)
	}
}
