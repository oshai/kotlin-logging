...
class LoggingTest {
  ...
  fun testMessages0() {
    ...
    assertAll(
      {
        assertEquals(
          "INFO  io.github.oshai.kotlinlogging.ClassWithLogging  - test ClassWithLogging",
          lines[0].trim()
        )
      },
      {
        assertEquals(
          "TRACE io.github.oshai.kotlinlogging.ClassWithLogging  - test ClassWithLogging",
          lines[1].trim()
        )
      },
  ...
  fun testMessages1() {
    ...
    assertAll(
      {
        assertEquals(
          "TRACE io.github.oshai.kotlinlogging.ClassWithLogging MARKER - test ClassWithLogging",
          lines[0].trim()
        )
      },
      {
  ...
  fun testMessages2() {
    ...
    appenderWithWriter.writer.flush()
    assertEquals(
      "INFO  io.github.oshai.kotlinlogging.ClassInheritLogging  - test ClassHasLogging",
  ...
  fun testMessages3() {
    ...
    appenderWithWriter.writer.flush()
    assertEquals(
      "INFO  io.github.oshai.kotlinlogging.ChildClassWithLogging  - test ChildClassWithLogging",
      appenderWithWriter.writer.toString().trim()
    )
  }
  ...
  fun testMessages4() {
    ...
    appenderWithWriter.writer.flush()
    assertEquals(
      "INFO  io.github.oshai.kotlinlogging.ClassWithNamedLogging  - test ClassWithNamedLogging",
      appenderWithWriter.writer.toString().trim()
    )
  }
  ...
  fun testMessages5() {
    ...
    appenderWithWriter.writer.flush()
    assertEquals(
      "INFO  io.github.oshai.kotlinlogging.ClassHasLogging  - test ClassHasLogging",
      appenderWithWriter.writer.toString().trim()
    )
  }
  ...
  fun testMessages6() {
    ...
    appenderWithWriter.writer.flush()
    assertEquals(
      "INFO  io.github.oshai.kotlinlogging.CompanionHasLogging  - test CompanionHasLogging",
      appenderWithWriter.writer.toString().trim()
    )
  }
  ...
  fun shouldNotFailForFailingLambdas() {
    ...
    appenderWithWriter.writer.flush()
    assertEquals(
      "INFO  io.github.oshai.kotlinlogging.LambdaRaisesError  - Log message invocation failed: java.lang.NullPointerException",
      appenderWithWriter.writer.toString().trim()
    )
  }
  ...
  fun placeholderFormatting() {
    ...
    appenderWithWriter.writer.flush()
    assertEquals(
      "INFO  io.github.oshai.kotlinlogging.ClassWithLogging  - Message: String with {} curly braces",
      appenderWithWriter.writer.toString().trim()
    )
  }
