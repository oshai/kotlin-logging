...
internal class LocationAwareKLogger(override val underlyingLogger: LocationAwareLogger) :
  ...
  override fun at(level: Level, marker: Marker?, block: KLoggingEventBuilder.() -> Unit) {
    if (isLoggingEnabledFor(level, marker)) {
      KLoggingEventBuilder().apply(block).run {
        underlyingLogger.log(marker?.toSlf4j(), fqcn, level.toSlf4j(), message, null, cause)
      }
    }
  }
  ...
  //    if (!underlyingLogger.isTraceEnabled) return
  //
  //    underlyingLogger.log(null, fqcn, LocationAwareLogger.TRACE_INT, msg, arrayOf(arg1, arg2),
  // null)
  //  }
  //
  ...
  //    if (!underlyingLogger.isTraceEnabled) return
  //    underlyingLogger.log(marker?.toSlf4j(), fqcn, LocationAwareLogger.TRACE_INT, msg, null,
  // null)
  //  }
  //
  ...
  //    if (!underlyingLogger.isDebugEnabled) return
  //
  //    underlyingLogger.log(null, fqcn, LocationAwareLogger.DEBUG_INT, msg, arrayOf(arg1, arg2),
  // null)
  //  }
  //
  ...
  //    if (!underlyingLogger.isDebugEnabled) return
  //    underlyingLogger.log(marker?.toSlf4j(), fqcn, LocationAwareLogger.DEBUG_INT, msg, null,
  // null)
  //  }
  //
  ...
  //    if (!underlyingLogger.isInfoEnabled) return
  //
  //    underlyingLogger.log(null, fqcn, LocationAwareLogger.INFO_INT, msg, arrayOf(arg1, arg2),
  // null)
  //  }
  //
  ...
  //    if (!underlyingLogger.isWarnEnabled) return
  //
  //    underlyingLogger.log(null, fqcn, LocationAwareLogger.WARN_INT, msg, arrayOf(arg1, arg2),
  // null)
  //  }
  //
  ...
  //    if (!underlyingLogger.isErrorEnabled) return
  //
  //    underlyingLogger.log(null, fqcn, LocationAwareLogger.ERROR_INT, msg, arrayOf(arg1, arg2),
  // null)
  //  }
  //
  ...
  //    if (!underlyingLogger.isErrorEnabled) return
  //    underlyingLogger.log(marker?.toSlf4j(), fqcn, LocationAwareLogger.ERROR_INT, msg, null,
  // null)
  //  }
  //
  ...
  //    underlyingLogger.log(THROWING, fqcn, LocationAwareLogger.ERROR_INT, "throwing", null,
  // throwable)
  //    throw throwable
  //  }
  //
